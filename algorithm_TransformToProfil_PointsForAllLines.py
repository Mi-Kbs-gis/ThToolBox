...
class TransformToProfil_PointsForAllLines(QgsProcessingAlgorithm):
    ...
    def name(self):
        ...
        """
        return self.tr('points_bore_axis_multi_baseline')
    ...
    def displayName(self):
        ...
        """
        return self.tr('Points (incl. Bore Axis) Multi Baseline')
